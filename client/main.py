...
class LoopSwitcherUI:
    ...
    def setup_ui(self):
        ...
        ttk.Button(btn_frame, text="Generate C Seed", command=self.export_c_seed).pack(side="right", padx=(8, 0))
    ...
    def export_c_seed(self):
        ...
        print(f"Exported successfully structured preset seed to: {self.output_path}")
